...
typedef TestEvent = {
	...
	**/
	@:optional var tests:Array<String>;
	...
	**/
	@:optional var test:EitherType<String, TestInfo>;
	@:optional var state:EitherType<TestState, TestSuiteState>;
	@:optional var suite:EitherType<String, TestSuiteInfo>;
	...
	**/
	@:optional var decorations:Array<TestDecoration>;
}
